...
**12회 중 3회 실패**다. 09-17 은 재실행만으로 붙었으니 러너 IP 대역이 고정적으로
차단된 것은 아니고, 일시적으로 도달하지 못하는 구간이 있다고 보는 편이 사실에 가깝다.
다만 **원인은 여전히 확정하지 못했다(확인 필요)** — 조달청 쪽 일시 장애인지, 특정
러너 대역의 문제인지 구분할 근거가 없다.
